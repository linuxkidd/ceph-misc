...
# Space separated CSV: host,osdid[,osdid]... host2,osdid[,osdid]...
# Example:
# osd_list="host1,0,1,2 host2,3,4,5"
#
...
# so we likely need to build this differently
...
log "CONFIRM: Please confirm this is formatted correctly to continue (hostname1,0,1,2 hostname2,3,4,5 ...). Press any key to continue, CTRL-C to quit"
read ans
